...
public class QueryCountFinishTrainingTest extends BaseApiTest {
    ...
    public void countFinishTrainingValidData() {
        ...
        Response response = TestUtil.templateGraphQLRequest(
                "countFinishTraining", query, null, config.getProperty("usernameGraphQl"), config.getProperty("passwordGraphQl"), sid
        );
